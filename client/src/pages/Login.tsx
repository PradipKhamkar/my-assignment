...
const Login = () => {
  ...
  const emailValidRegex = /^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+$/;
              ...
              <div className="h-full w-full flex justify-between flex-col">
                <div>
                  ...
                  <div className="px-5 py-0 flex  justify-end">
                    <Link
                      to="/forgetpassword"
                      className="text-sm text-right cursor-pointer text-lightViolet"
                    >
                      forget password?
                    </Link>
                  </div>
                ...
                <div className=" p-5">
                  <button
                    className="w-full bg-darkViolet p-2 rounded-sm text-white text-base"
