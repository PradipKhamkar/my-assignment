  ...
  return (
    <BoxContainer clasName="flex flex-col justify-between p-5  pb-8">
      <div>
        ...
        <div className="mt-16 flex justify-start flex-wrap md:gap-10 gap-14">
          <TextInput
            value={categoryName}
            label="Category Name"
            handelChange={setCategoryName}
            className="md:w-80 w-full"
          />
          <TextInput
            value={desc}
            label="Description"
            handelChange={setDesc}
            className="md:w-80 w-full"
          />
          <DropDownInput
            value={status}
      ...
      <div className="flex lg:justify-end gap-8 items-center justify-center">
        ...
        <button className="bg-[#662671] text-white text-base border-none outline-none rounded-2xl px-5 md:px-14 py-2">
          Save
        </button>
      </div>
    </BoxContainer>
